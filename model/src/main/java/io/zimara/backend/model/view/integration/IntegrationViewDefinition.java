package io.zimara.backend.model.view.integration;
...
public class IntegrationViewDefinition extends ViewDefinition {


    public IntegrationViewDefinition() {

    }


    public IntegrationViewDefinition(ViewDefinition v) {
        this.id = v.getId();
        this.name = v.getName();
        this.type = v.getType();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IntegrationViewDefinition)) return false;

        IntegrationViewDefinition that = (IntegrationViewDefinition) o;
