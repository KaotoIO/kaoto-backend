...
public interface Connector
        extends WithId<Connector>, WithIdVersioned<Connector>,
        WithVersion.AutoUpdatable, WithActions<ConnectorAction>, WithTags,
        WithName, WithProperties, WithDependencies, WithMetadata, ToJson,
        Serializable {
    ...
    class Builder extends ImmutableConnector.Builder
            implements WithPropertiesBuilder<Builder> {
    }
}
