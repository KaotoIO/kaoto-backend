...
public enum Kind {
    ...
    ConnectionOverview(
            io.syndesis.common.model.connection.ConnectionOverview.class),
    ...
    ConnectorTemplate(
            io.syndesis.common.model.connection.ConnectorTemplate.class),
    ...
    IntegrationOverview(
            io.syndesis.common.model.integration.IntegrationOverview.class),
    IntegrationDeployment(IntegrationDeployment.class),
    IntegrationDeploymentStateDetails(
            io.syndesis.common.model.monitoring.IntegrationDeploymentStateDetails.class),
    IntegrationMetricsSummary(
            io.syndesis.common.model.metrics.IntegrationMetricsSummary.class),
    IntegrationRuntime(
            io.syndesis.common.model.integration.IntegrationRuntime.class),
    IntegrationEndpoint(
            io.syndesis.common.model.integration.IntegrationEndpoint.class),
    ...
    //Quota(io.syndesis.common.io.syndesis.common.model.user.Quota.class),

    ConnectionBulletinBoard(
            io.syndesis.common.model.bulletin.ConnectionBulletinBoard.class),
    IntegrationBulletinBoard(
            io.syndesis.common.model.bulletin.IntegrationBulletinBoard.class),

    OpenApi(io.syndesis.common.model.openapi.OpenApi.class),

    // we need the enum value for API calls, we don't need the io.syndesis.common.model object
     ...
     * io.syndesis.common.model names to enum values.
     */
    ...
    abstract static class ModelPlaceholder implements WithKind {
        // placeholder for kinds without io.syndesis.common.model
