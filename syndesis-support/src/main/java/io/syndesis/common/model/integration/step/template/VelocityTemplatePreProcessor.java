...
class VelocityTemplatePreProcessor
        extends AbstractTemplatePreProcessor<VelocityContext> {
    ...
    @Override
    protected void parseSymbol(VelocityContext context, String literal,
                               StringBuilder buff)
