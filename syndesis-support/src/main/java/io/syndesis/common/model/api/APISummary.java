...
public interface APISummary extends WithName, WithConfigurationProperties,
        WithConfiguredProperties {
    ...
    final class Builder extends ImmutableAPISummary.Builder {
        ...
        public static Builder createFrom(final Connector connector) {
            ...
            final Builder builder = new Builder().createFrom(
                            (WithConfigurationProperties) connector)
