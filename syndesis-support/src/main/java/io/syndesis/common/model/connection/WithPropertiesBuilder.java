...
public interface WithPropertiesBuilder<T extends WithPropertiesBuilder<T>> {
     ...
     */
    default String putOrRemoveProperty(final Map<String, String> properties,
    ...
    default T putOrRemoveConfiguredPropertyTaggedWith(final String tag,
        ...
        final Map<String, String> configuredProperties =
                withProperties.getConfiguredProperties();

        final Map<String, String> mutableCopy =
                new HashMap<>(configuredProperties);

        withProperties.propertyEntryTaggedWith(tag)
                .ifPresent(entry -> putOrRemoveProperty(mutableCopy,
                        entry.getKey(), value));
