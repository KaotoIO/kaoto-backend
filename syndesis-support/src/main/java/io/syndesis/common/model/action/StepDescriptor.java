...
public interface StepDescriptor extends ActionDescriptor, Serializable {
    ...
    final class Builder extends ImmutableStepDescriptor.Builder {
        ...
        public StepDescriptor.Builder replaceConfigurationProperty(
            ...
            final ConfigurationProperty configurationProperty =
                    step.getProperties().get(propertyName);
        ...
        public StepDescriptor.Builder withInputDataShape(
                final Optional<DataShape> inputDataShape) {
            return inputDataShape(inputDataShape);
        }

        public StepDescriptor.Builder withOutputDataShape(
