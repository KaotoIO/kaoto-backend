...
/**
 * Provides languages io.syndesis.common.model for use with the template step feature.
...
public class TemplateStepLanguage {
    ...
    private TemplateStepLanguage(String name, String mvnDependency,
                                 String camelHeader,
                                 TemplateStepPreProcessor<?> preProcessor) {
        this.name = name;
