...
@JsonDeserialize(using = InvalidStepDeserializer.class)
public class InvalidStep implements FlowStep {
    public static final String LOAD_BALANCE_LABEL = "invalid";
    ...
    public InvalidStep(final Step step, final KamelPopulator kameletPopulator) {
