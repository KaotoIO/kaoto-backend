...
//                                "./browse.json").toURI()).toFile();
        ...
        Step parsedStep = new CamelRouteFileProcessor().parseFile(camelRouteJson);
        ...
        parsedStep.getParameters().forEach(
                parameter -> {
                    ...
                    assertEquals(parameter.getDescription(), expectedParameterValues.get(parameter.getId()).getDescription());
                    assertEquals(parameter.getTitle(), expectedParameterValues.get(parameter.getId()).getTitle());
                    assertEquals(parameter.getDefaultValue(), expectedParameterValues.get(parameter.getId()).getDefaultValue());
