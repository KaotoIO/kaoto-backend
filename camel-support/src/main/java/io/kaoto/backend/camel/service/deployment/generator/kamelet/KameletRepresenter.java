...
import io.kaoto.backend.camel.model.deployment.kamelet.step.ConvertBodyToFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.DelayFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.DynamicRouterFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.EnrichFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.Filter;
import io.kaoto.backend.camel.model.deployment.kamelet.step.FilterFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.From;
import io.kaoto.backend.camel.model.deployment.kamelet.step.IdempotentConsumerFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.LoadBalanceFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.LogFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.LoopFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.MarshalFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.MulticastFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.PipelineFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.PollEnrichFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.ProcessFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.RecipientListFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.RemoveHeaderFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.RemoveHeadersFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.RemovePropertiesFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.RemovePropertyFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.ResequenceFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.RollbackFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.RoutingSlipFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.SagaFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.SampleFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.ScriptFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.ServiceCallFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.SetBodyFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.SetExchangePatternFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.SetHeaderFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.SetPropertyFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.SortFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.SplitFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.StopFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.ThreadsFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.ThrottleFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.ThrowExceptionFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.ToDynamicFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.ToFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.TransactedFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.TransformFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.TryCatchFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.UnmarshalFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.UriFlowStep;
import io.kaoto.backend.camel.model.deployment.kamelet.step.ValidateFlowStep;
